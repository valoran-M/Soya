...
(*       | Rtl.ILoad  (a, r, n) -> assert false *)
(*       | Rtl.IStore (a, r, n) -> assert false *)
(*       | Rtl.IPush (r, n) -> assert false *)
(*       | Rtl.IPop (r, n) -> assert false *)
(*       | Rtl.ICall (id, _, i, n) -> push_node i (ICall (id, i, n)) *)
(*       | Rtl.ICond (c, lr, nt, nf) -> push_node i () *)
